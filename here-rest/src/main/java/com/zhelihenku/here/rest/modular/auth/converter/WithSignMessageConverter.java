package com.zhelihenku.here.rest.modular.auth.converter;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.support.spring.FastJsonHttpMessageConverter;
import com.zhelihenku.here.core.exception.HereException;
import com.zhelihenku.here.core.support.HttpKit;
import com.zhelihenku.here.core.util.MD5Util;
import com.zhelihenku.here.rest.common.exception.BizExceptionEnum;
import com.zhelihenku.here.rest.config.properties.JwtProperties;
import com.zhelihenku.here.rest.modular.auth.security.DataSecurityAction;
...
public class WithSignMessageConverter extends FastJsonHttpMessageConverter {
    ...
    public Object read(Type type, Class<?> contextClass, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        ...
        if (encrypt.equals(baseTransferEntity.getSign())) {
            ...
            throw new HereException(BizExceptionEnum.SIGN_ERROR);
        }
