package com.zhelihenku.here.core.config;

import com.zhelihenku.here.core.base.controller.GunsErrorView;
import com.zhelihenku.here.core.exception.HereException;
import com.zhelihenku.here.core.exception.HereExceptionEnum;
import com.zhelihenku.here.core.util.DateUtil;
    ...
    public class StringToDateConverter implements Converter<String, Date> {
        ...
        public Date convert(String dateString) {
            ...
            if (dateFlag) {
                ...
                throw new HereException(HereExceptionEnum.INVLIDE_DATE_STRING);
            }
